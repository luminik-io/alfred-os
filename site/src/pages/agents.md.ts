...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines: string[] = [
    ...
    "  configurable approval gate. It files scoped child issues; Lucius, Bane,",
    "  Nightwing, reviewers, and the merge gate carry the child PRs.",
    "",
    ...
    "  Nightwing, and the normal review/merge gates. It does not directly edit",
    "  repo files in the OSS runner. Immediate child filing is",
