...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines: string[] = [
    ...
    "## What Alfred is",
    "",
    "Alfred is an open-source agent engineering team that works while",
    "the operator is away from the keyboard. It coordinates Claude Code",
    "and Codex CLI sessions on a",
    ...
    "for engineering work that should keep moving without the operator at",
    "the keyboard: planned features, follow-up tests, reviewer comments,",
    "dependency bumps, docs gaps, and multi-repo rollouts. A scheduler",
