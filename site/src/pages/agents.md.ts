...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines: string[] = [
    ...
    "## What Alfred is",
    "",
    "Alfred is an open-source system for autonomous coding agents that",
    "work through approved GitHub tasks while the operator is away from",
    "the keyboard. It coordinates Claude Code and Codex CLI sessions on a",
    ...
    "for approved engineering work that should keep moving without the",
    "operator at the keyboard: planned features, follow-up tests, reviewer",
    "comments, dependency bumps, docs gaps, and multi-repo rollouts. A scheduler",
    "fires each agent at a configured cadence; the harness wraps every",
    "firing in a lock, preflight, spend cap, and an isolated git worktree.",
    "",
    "## How to install",
    "",
