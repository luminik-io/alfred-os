...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines: string[] = [
    ...
    "## What Alfred is",
    "",
    "Alfred is an open-source local runtime for coding agents that turn",
    "specs and GitHub issues into PRs while the operator is away. It",
    ...
    "at the keyboard: planned features, follow-up tests, reviewer comments,",
