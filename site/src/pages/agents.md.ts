...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines: string[] = [
    ...
    "systemd. Each agent is a named role (Batman is the architect that leads",
    "multi-repo rollouts, Lucius is the senior developer, Drake scopes the next work,",
    "and Ra's al Ghul is the reviewer) with its own prompt, schedule, and label",
    "discipline.",
    ...
    "  configurable Slack approval gate.",
    "",
    ...
    "  Batman can turn an approved rollout into child issues for Lucius, Bane,",
    "  Nightwing, and the normal review/merge gates. Immediate child filing is",
    "  available only when you explicitly choose that execution mode.",
    "",
