...
The full doc lives at [`docs/LINUX.md`](https://github.com/luminik-io/alfred-os/blob/main/docs/LINUX.md). The highlights:
...
If you want to do this work, see [Contributing](/alfred-os/about/contributing/) — we'll happily review a PR. If you want to *fund* it, file an issue with your willingness to sponsor.
