...
description: Week two of running Alfred. Slack rhythm, CLI recipes, sentinels, log paths, and a runbook for when the fleet goes quiet.
---
...
See [State and memory](/concepts/state-and-memory/) for the full directory tree.
...
- [Architecture](/concepts/architecture/): the design that makes this runbook short.
