---
title: Alfred-OS
description: Cron-driven Claude Code agent fleet for one operator, one Mac.
template: splash
hero:
  tagline: A framework for cron-driven Claude Code agents on a single Mac.
  actions:
    - text: Install (30 min)
...
<CardGrid stagger>
  <Card title="Cron-driven dispatch" icon="rocket">
