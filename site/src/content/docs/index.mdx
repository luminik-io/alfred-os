---
title: Alfred
description: Turn GitHub issues and specs into autonomous Claude Code and Codex runs. PRs, reviews, tests, and Slack reports come back.
template: splash
head:
  - tag: title
    content: "Alfred: autonomous Claude Code and Codex runs from GitHub issues"
hero:
  tagline: Turn GitHub issues and specs into autonomous Claude Code and Codex runs. PRs, reviews, tests, and Slack reports come back.
  image:
...
A coding agent can complete a prompt. Recurring engineering work needs durable coordination: scope in GitHub, specs that describe intent, labels that show state, clean worktrees, review rules, and visible output.
