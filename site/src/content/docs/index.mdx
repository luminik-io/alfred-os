...
Alfred-OS is at v0.2.0. This is the public release candidate for a complete local engineering-agent fleet. The framework substrate (`agent_runner`) is stable for the operator's own use; expect rough edges if you fork.
