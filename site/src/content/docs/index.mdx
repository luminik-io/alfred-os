---
title: Alfred
description: A self-hosted runtime for autonomous Claude Code and Codex agents. Scoped GitHub issues and specs come in; reviewed pull requests, tests, and Slack reports come back, on the CLI subscriptions you already pay for.
template: splash
head:
  - tag: title
    content: "Alfred: self-hosted runtime for autonomous Claude Code and Codex agents"
hero:
  tagline: "GitHub issues, in. Pull requests, out. A self-hosted runtime for autonomous Claude Code and Codex agents on the CLI subscriptions you already pay for."
  image:
