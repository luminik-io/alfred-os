---
title: Alfred
description: A local agent-fleet runtime for solo builders. Claude Code and Codex-capable development agents scheduled by launchd or systemd, on a machine you control.
template: splash
head:
  - tag: title
    content: "Alfred: the solo builder's agent OS"
hero:
  tagline: Run a small fleet of Claude Code and Codex agents from a machine you control.
  image:
