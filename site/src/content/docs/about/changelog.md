...
- **Solo-builder setup cleanup**: `alfred-init.py --repos`, full-fleet default, prompt seeding, standard GitHub label setup, Batman visible as a runner-gated cross-repo architect, and config-heavy jobs kept disabled until their required settings exist.
