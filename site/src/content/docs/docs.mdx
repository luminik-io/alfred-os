...
<LinkCard
  title="Native local client direction"
  description="The Mac/Linux app should be a thin local control plane while Slack stays the collaboration surface."
