...
<LinkCard
  ...
  description="The full engineering roster: Batman, Lucius, Drake, Ra's al Ghul, Bane, Nightwing, Robin, Huntress, Gordon, automerge, memory, code-map, cleanup, reports, and fleet doctor. What each codename does and how work flows between them."
  href="/concepts/fleet/"
/>

<LinkCard
  title="Alfred Desktop"
  description="The Mac/Linux app installs or repairs core, guides setup, and operates the local fleet while Slack stays the collaboration surface."
