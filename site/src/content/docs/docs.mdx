---
title: Alfred
description: A local coding-agent runtime that opens reviewed pull requests. Alfred plans across your repos or monorepo packages, implements with the Claude Code and Codex subscriptions you already pay for, and reports to Slack.
template: splash
head:
  - tag: title
    content: "Alfred: an autonomous engineering team for Claude Code and Codex"
hero:
  tagline: "A local runtime for coding agents that open reviewed PRs. Alfred plans across your repos or monorepo packages, implements with your Claude Code and Codex subscriptions, and reports to Slack."
  image:
...
Interactive coding agents finish a prompt while you sit at the keyboard. Alfred is built for queued engineering work that does not need you at the keyboard: planned features, follow-up tests, reviewer comments, dependency bumps, docs gaps, multi-repo rollouts.
