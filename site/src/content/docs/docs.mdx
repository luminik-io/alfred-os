...
The engineering fleet ships today. The local memory layer and read-only fleet
UI also ship today. The next larger categories are content, sales, and ops;
...
<CardGrid>
  ...
  <Card title="Memory" icon="puzzle">Local recall, reviewable lesson candidates, failure history, and read-only MCP access.</Card>
</CardGrid>
