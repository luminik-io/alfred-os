---
title: Alfred
description: Alfred is an agent engineering team that works while you are away. It plans across repos or monorepo packages, implements with the Claude Code and Codex subscriptions you already pay for, opens pull requests, routes review, and reports to Slack.
template: splash
head:
  - tag: title
    content: "Alfred: an agent engineering team that works while you are away"
hero:
  tagline: "An agent engineering team that works while you are away. Alfred plans across repos or monorepo packages, implements with your Claude Code and Codex subscriptions, opens pull requests, routes review, and reports to Slack."
  image:
